...
// Source: E:\VSCodeFile/testovoeOzon/PostCommentService/internal/gateway/gateway.go
//
...
func (m *MockPost) GetAllPosts(limit, offset int) ([]*model.Post, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPostMockRecorder) GetAllPosts(limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllPosts", reflect.TypeOf((*MockPost)(nil).GetAllPosts), limit, offset)
}
...
func (m *MockComment) GetCommentsByPost(postId, limit, offset int) ([]*model.Comment, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommentMockRecorder) GetCommentsByPost(postId, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCommentsByPost", reflect.TypeOf((*MockComment)(nil).GetCommentsByPost), postId, limit, offset)
}
